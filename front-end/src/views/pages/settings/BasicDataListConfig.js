...
import {
  ...
  addData,
  filterData
} from "../../../redux/actions/basicquestions"
import Sidebar from "./BasicDataListSidebar"
...
class BasicDataListConfig extends Component {
  ...
  static getDerivedStateFromProps(props, state) {
    if (props.dataList.data.length !== state.data.length || state.currentPage !== props.parsedFilter.page1) {
      return {
        data: props.dataList.data,
        allData: props.dataList.filteredData,
        totalPages: props.dataList.totalPages,
        currentPage: parseInt(props.parsedFilter.page1) - 1,
  ...
  componentDidMount() {
    if(Object.keys(this.props.parsedFilter).length === 0)//empty object
    {
      ...
      this.props.getData({page:this.props.parsedFilter.page1, perPage: 4});
  }
  ...
  handleRowsPerPage = value => {
    ...
    let page = parsedFilter.page1 !== undefined ? parsedFilter.page1 : 1
    history.push(`?page1=${page}&perPage=${value}`)
    this.setState({ rowsPerPage: value })
    getData({ page: parsedFilter.page1, perPage: value })
  }
  ...
  handlePagination = page => {
    ...
    let urlPrefix = this.props.thumbView
      ...
      : ""
    history.push(
      `${urlPrefix}?page1=${page.selected + 1}&perPage=${perPage}`
    )
    console.log("handlePage", this.props.parsedFilter);
        ...
        <DataTable
          ...
          paginationComponent={() => (
            <ReactPaginate
              ...
              forcePage={
                this.props.parsedFilter.page1
                  ? parseInt(this.props.parsedFilter.page1 - 1)
                  : 0
              }
