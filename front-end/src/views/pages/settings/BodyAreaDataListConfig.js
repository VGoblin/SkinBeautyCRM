...
import {
  ...
  addData,
  filterData
} from "../../../redux/actions/bodyarea"
import Sidebar from "./BodyAreaDataListSidebar"
...
const CustomHeader = props => {
  return (
    <div className="data-list-header d-flex justify-content-between flex-wrap">
      ...
      {/* <h5 className="align-middle mt-1">Body Area</h5> */}
...
class BodyAreaDataListConfig extends Component {
